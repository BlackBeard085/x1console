...
if echo "$HEALTH_OUTPUT" | grep -q "WARNING"; then
    ...
    BALANCE_OUTPUT=$(node $HOME/x1console/epoch_balances.js && echo "" && ~/x1console/pinger-status.sh && echo "" && echo "Performance:" && $HOME/x1console/latency.sh  && echo "" && echo "Skipped slots" && node $HOME/x1console/skips.js &&  ./scheduled_update.sh)
#    sleep 3
    ...
    BALANCE_OUTPUT=$(node $HOME/x1console/epoch_balances.js && echo "" && $HOME/x1console/pinger-status.sh && echo "" && echo "Performance:" && $HOME/x1console/latency.sh && echo "" && echo "Skipped slots" && node $HOME/x1console/skips.js &&  ./scheduled_update.sh)
#    sleep 3
