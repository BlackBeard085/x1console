...
Launch the Athority Manager through the other menu option 4. It will display your currently set withdrawer (current logge in wallet) at the top, followed by stake and vote wallets and their corresponding withdraw authority wallet in the opening dash. The menu will show you two option.
